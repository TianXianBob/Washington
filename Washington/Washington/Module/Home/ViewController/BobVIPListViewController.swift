//
//  BobVIPListViewController.swift
//  Washington
//
...
class BobVIPListViewController: BobBaseViewController {
...
extension BobVIPListViewController: UCollectionViewSectionBackgroundLayoutDelegateLayout, UICollectionViewDataSource{
    ...
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, referenceSizeForFooterInSection section: Int) -> CGSize {
        return vipList.count - 1 != section ? CGSize(width: UScreenWidth, height: 10) : CGSize.zero
    }
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        let vc = BobComicDetailViewController(comicid: model.comicId)
